export default function setPrecos(optForm, setAttributes) {
  ...
  optForm.appendChild(titleOptPrices);
  ...
  setAttributes(inputFaixa1, attributes);
  ...
  setAttributes(inputFaixa2, attributes2);
  ...
  optForm.appendChild(inputSpan2);
  ...
  setAttributes(inputFaixa3, attributes3);
  ...
  optForm.appendChild(inputSpan3);
  ...
  setAttributes(inputFaixa4, attributes4);
  ...
  optForm.appendChild(inputSpan4);
  ...
  setAttributes(inputFaixa5, attributes5);
